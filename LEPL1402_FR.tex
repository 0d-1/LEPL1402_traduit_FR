...
\begin{center}
\includegraphics[width=0.9\linewidth]{figures/ch5_cpu_cores}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\linewidth]{figures/ch5_process_threads}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\linewidth]{figures/ch5_thread_sequence}
\end{center}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{81.png}
  \caption{}
\end{figure}
...
\begin{center}
\includegraphics[width=0.7\linewidth]{figures/ch5_swing_buttons}
\end{center}
...
\begin{center}
\includegraphics[width=0.85\linewidth]{figures/ch5_split_array_two_threads}
\end{center}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/ch5_thread_pool}
\end{figure}
...
L’écart-type peut être dérivé de la variance, qui peut être calculée à partir du nombre d’éléments dans le bloc, de la somme des éléments dans le bloc, et de la somme des carrés des éléments dans le bloc : \texttt{https://en.wikipedia.org/wiki/Algorithms_for_calculating_variance} (cf. algorithme naïf).
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/ch5_race_condition}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{91.png}
  \caption{}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{92.png}
  \caption{}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{93.png}
  \caption{}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{94.png}
  \caption{}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{96.png}
  \caption{}
\end{figure}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\textwidth]{97.png}
  \caption{}
\end{figure}
...
public class Miles {
  static public void main(String args[]) {
    ...
    List<String> kilometers = miles.stream()
      ...
      .map(s -> Float.parseFloat(s))       // De chaîne vers float
      .map(x -> x * 1609.344f)             // De miles vers mètres
      .map(x -> x / 1000.0f)               // De mètres vers kilomètres
      .map(x -> String.valueOf(x))         // De float vers chaîne
...
// Notez que nous aurions pu écrire : stream.map(String::length);
\end{lstlisting}
...
// Notez que nous aurions pu écrire : accounts.map(Account::getValue);
\end{lstlisting}
...
// Notez que nous aurions pu écrire : values.map(Account::new);
\end{lstlisting}
...
Stream<Integer> s1 = Stream.of(1, 2, 3, 4, 5);
Stream<Integer> s2 = s1.map(i -> { System.out.println(i); return i + 1; });
Object[] a = s2.toArray(); // <- ici, tous les éléments du flux sont nécessaires
\end{lstlisting}
...
Stream<Integer> s1 = Stream.of(1, 2, 3, 4, 5);
Stream<Integer> s2 = s1.map(i -> { System.out.println(i); return i + 1; });
Object[] a = s2.limit(2).toArray(); // <- ici, seuls les deux premiers éléments du flux sont nécessaires
\end{lstlisting}
...
List<String> kilometers = miles.stream()
  .filter(s -> !s.isEmpty())                 // Ignorer les chaînes vides
  .mapToDouble(s -> Double.parseDouble(s))   // (*) De chaîne vers double
  .map(x -> x * 1609.344)                    // De miles vers mètres
  .map(x -> x / 1000.0)                      // De mètres vers kilomètres
  .mapToObj(x -> String.valueOf(x))          // (*) De double vers chaîne
  .collect(Collectors.toList());             // Construire la liste
\end{lstlisting}
